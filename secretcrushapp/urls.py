...
urlpatterns = [
    ...
    path('notes/sent/', views.sentMessages, name='sentMessages'),
    path('notes/send/', views.sendMessage, name='sendMessage'),
    path('notes/received/', views.receivedMessages, name='receivedMessages'),
    path('notes/delete/', views.deleteMessage, name='deleteMessage'),
    path('notes/hide/', views.hideMessage, name='hideMessage'),
    path('notes/report/', views.reportMessage, name='reportMessage'),
    path('notes/blacklist/', views.editBlacklistView, name='messageBlacklist')
]