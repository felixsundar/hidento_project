...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='InstagramCrush',
            fields=[
                ('instagram_userid', models.CharField(max_length=255, primary_key=True, serialize=False, unique=True)),
                ...
                ('hidento_userid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, unique=True)),
            ],
        ),
    ]
